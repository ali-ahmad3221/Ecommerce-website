<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#customer-basic" aria-expanded="false" aria-controls="customer-basic">
                <i class="icon-layout menu-icon"></i>
                <span class="menu-title">Customers</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="customer-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('our.customers')}}">All Customers</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
